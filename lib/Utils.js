 ...
 * @returns {string|null}
 */
function convertTypeToXsd(type, isArray=false) {
    switch(type.type) {
        case(parser.AST_NODE_TYPES.TSTypeReference):
            // We do this to deal with JavaScript types such as Boolean, Number, String
            let typeName = type.typeName.name;
...
function copyContext(fromDeclaration, to) {
    for (let contextFile of getArray(fromDeclaration.component.componentsContent, "@context")) {
