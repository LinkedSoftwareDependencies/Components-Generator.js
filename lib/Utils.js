                ...
                switch (tag.tag) {
                    case rangeTag:
                        ...
                        if (isValidXsd(fieldType, type)) {
                            ...
                            logger.error(`Found range type ${type} but could not match to ${fieldType}`);
                        }
                        break;
                    case requiredTag:
                        required = true;
...
/**
 * Unions a set by adding the content of the second set to the first one
